...
//********** Main react functional component of grid **********
function DataGridMl6() {
  //****All states are defined with useState for different state change*****
  const [data, setData] = useState([]);
  let [disable, setDisable] = useState(true);
  const [butDisColor, setButDisColor] = useState("#5A5A5A");
...
const [pageSize, setPageSize] = useState(10);
  ...
  //**** fetch users api call function to fetch data from java backend ****
  ...
  //rows selector function to select rows using checkboxes
  ...
  //*** Function for EDIT data dialogbox ***
  ...
  //***** Function for DELETE data dialogbox *****
  ...
  const handleCloseDelete = async (a) => {
    ...
    //***** Function for PREDICT data and update in Order Amount *****
  ...
  return (
    <>
      ...
      >
        ...
        <DialogActions>
          <Button onClick={() => handleCloseDelete(false)} color="primary" variant="outlined" style={{width: "50%"}}>
            CANCEL
          </Button>
          <Button onClick={() => handleCloseDelete(true)} color="primary" variant="outlined" style={{width: "50%"}}>
            DELETE
          </Button>
        </DialogActions>
      </Dialog>
