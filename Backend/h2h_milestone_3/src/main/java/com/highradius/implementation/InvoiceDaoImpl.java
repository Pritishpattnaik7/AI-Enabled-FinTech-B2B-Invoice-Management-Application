//This is the main file , where I have implemented all the methods like add, update, delete, print
	...
	public List<Invoice> getInvoice() {
		...
		try {
			...
			while(resultSet.next()) {
				...
				//Adding the new invoice to the list
